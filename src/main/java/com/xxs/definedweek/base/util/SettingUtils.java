 ...
 */
package com.xxs.definedweek.base.util;
...
import com.xxs.definedweek.base.CommonAttributes;
import com.xxs.definedweek.base.EnumConverter;
import com.xxs.definedweek.base.bean.Setting;
	...
	public static Setting get() {
		...
		if (cacheElement != null) {
			...
			try {
				...
				List<Element> elements = document.selectNodes("/definedweek/setting");
	...
	public static void set(Setting setting) {
		try {
			...
			try {
				...
				fileOutputStream = new FileOutputStream(definedweekXmlFile);
