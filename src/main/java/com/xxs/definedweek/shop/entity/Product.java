...
public class Product extends BaseEntity {
	...
	static {
		try {
			...
			org.dom4j.Element element = (org.dom4j.Element) document.selectSingleNode("/definedweek/template[@id='productContent']");
...
//	@Field(store = Store.YES, index = Index.TOKENIZED, analyzer = @Analyzer(impl = IKAnalyzer.class))
	@Field(store = Store.YES, analyzer = @Analyzer(impl = IKAnalyzer.class))
	@NotEmpty
	@Length(max = 200)
