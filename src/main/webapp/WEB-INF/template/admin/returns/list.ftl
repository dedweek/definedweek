...
<title>${message("admin.returns.list")} - Powered By SHOP++</title>
	...
	<form id="listForm" action="list.jhtml" method="get">
			...
			<div class="menuWrap">
				...
				<div class="popupMenu">
					<ul id="searchPropertyOption">
						<li>
							<a href="javascript:;"[#if page.searchProperty == "sn"] class="current"[/#if] val="sn">${message("Returns.sn")}</a>
						</li>
						<li>
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="shippingMethod">${message("Returns.shippingMethod")}</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="deliveryCorp">${message("Returns.deliveryCorp")}</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="trackingNo">${message("Returns.trackingNo")}</a>
				</th>
				<th>
