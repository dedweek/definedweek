...
<title>${message("admin.purchaseRanking.list")} - Powered By SHOP++</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.purchaseRanking.list")}
	</div>
	<form id="listForm" action="list.jhtml" method="get">
			...
			<div class="buttonWrap">
				...
				<div class="menuWrap">
					<a href="javascript:;" id="countSelect" class="button">
						${message("admin.purchaseRanking.count")}<span class="arrow">&nbsp;</span>
					</a>
					<div class="popupMenu">
						<ul id="countOption">
							<li>
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<span>${message("admin.purchaseRanking.memberEmail")}</span>
				</th>
				<th>
