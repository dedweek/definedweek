...
<title>${message("admin.attribute.list")} - Powered By SHOP++</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.attribute.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
			...
			<div class="menuWrap">
				...
				<div class="popupMenu">
					<ul id="searchPropertyOption">
						<li>
							<a href="javascript:;"[#if page.searchProperty == "name"] class="current"[/#if] val="name">${message("Attribute.name")}</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<table id="listTable" class="list">
			...
			[#list page.content as attribute]
				<tr>
					...
					<td>
						<a href="edit.jhtml?id=${attribute.id}">[${message("admin.common.edit")}]</a>
					</td>
				</tr>
			[/#list]
		</table>
