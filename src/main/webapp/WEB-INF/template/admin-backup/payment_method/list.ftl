...
<title>${message("admin.paymentMethod.list")} - Powered By SHOP++</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.paymentMethod.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
			...
			<div class="menuWrap">
				...
				<div class="popupMenu">
					<ul id="searchPropertyOption">
						<li>
							<a href="javascript:;"[#if page.searchProperty == "name"] class="current"[/#if] val="name">${message("PaymentMethod.name")}</a>
						</li>
					</ul>
				</div>
			</div>
