...
<title>${message("admin.adPosition.list")} - Powered By SHOP++</title>
...
<body>
	<div class="path">
		<a href="${base}/admin/common/index.jhtml">${message("admin.path.index")}</a> &raquo; ${message("admin.adPosition.list")} <span>(${message("admin.page.total", page.total)})</span>
	</div>
